...
opts_chunk$set(dev = 'jpeg', dpi = 120, out.width = '650px')
```
...
```{r sem_sample_plots, message = FALSE, echo = FALSE}
...
```{r sem_normal_plot, message = FALSE, echo=FALSE}
...
```{r sem_percentile_plot, echo = FALSE}
